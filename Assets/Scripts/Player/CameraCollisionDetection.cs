...
// Thanks to https://www.youtube.com/watch?v=Uqi2jEgvVsI
[System.Serializable]
public class CameraCollisionDetection
{
    ...
    // The clip points that surround the camera current position.
    [HideInInspector] public Vector3[] adjustedCameraClipPoints; 
    
    // The clip points that surround the cameras expected position if it wasnt colliding with anything.
